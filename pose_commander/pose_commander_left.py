...
class PoseCommander(Node):
    def __init__(self, node_name: str) -> None:
        ...
        self.callback_group.add_entity(self.lbr_state_sub_)
        ...
        self.callback_group.add_entity(self.target_pose_sub)
    ...
    def plan_new_joint_target(self, msg):
        ...
        joint_target = msg.joint_position #[msg.joint_position[0], msg.joint_position[1], msg.joint_position[2], msg.joint_position[3], msg.joint_position[4], msg.joint_position[5], msg.joint_position[6]]
