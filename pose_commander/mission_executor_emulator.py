...
class LLM_Executor_Server(Node):
    def __init__(self):
        ...
        self.llm_executor_service_ = self.create_timer(1.0, self.llm_service_callback)
    ...
    def llm_service_callback(self):
        ...
        if self.run_once == True:
            ...
            left_pose.px = float(0.35)
            left_pose.py = float(0.2)
            left_pose.pz = float(0.143)
            ...
            right_pose.px = float(-0.35)
            right_pose.py = float(0.4)
            right_pose.pz = float(0.183)
            right_pose.qx = float(0)
            right_pose.qy = float(0)
            right_pose.qz = float(-1)
